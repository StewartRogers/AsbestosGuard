...
// Applications API
export const createApplication = async (filename, data) => {
...
export const updateApplication = async (filename, data) => {
    const response = await axios.put(`${API_BASE_URL}/applications/${filename}`, { data });
    return response.data;
};
export const deleteApplication = async (filename) => {
    const response = await axios.delete(`${API_BASE_URL}/applications/${filename}`);
    return response.data;
};
// Fact Sheets API
export const createFactSheet = async (filename, data) => {
...
export const updateFactSheet = async (filename, data) => {
    const response = await axios.put(`${API_BASE_URL}/fact-sheets/${filename}`, { data });
    return response.data;
};
export const deleteFactSheet = async (filename) => {
    const response = await axios.delete(`${API_BASE_URL}/fact-sheets/${filename}`);
    return response.data;
};
// AI Analysis API
export const saveAnalysis = async (filename, data) => {
