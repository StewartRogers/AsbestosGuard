  ...
  try {
    ...
    for (const folder of folders) {
      ...
      for (const file of files) {
        ...
        try {
          if (folder === 'applications') await svc.saveApplication(name, content);
          else if (folder === 'fact-sheets') await svc.saveFactSheet(name, content);
          else if (folder === 'analysis') await svc.saveAnalysis(name, content);
